...
function TaskBar(){
    ...
    return(
        <main className = 'relative bg-black min-h-screen pt-60 sm:pt-60 md:pt-60 lg:pt-60 lg:pt-60 pb-10'>
            <Link to="/" className="absolute left-2 top-2 z-50 bg-neutral-900 border border-neutral-700 rounded-full p-2 shadow-md hover:bg-neutral-800 transition sm:left-4 sm:top-4 md:left-4 md:top-4 text-neutral-700">
                <ArrowLeft size={16} />
            </Link>
